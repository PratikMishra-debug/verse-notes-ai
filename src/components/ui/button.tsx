  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-muted hover:text-muted-foreground shadow-soft",
        ...
        hero: "bg-gradient-hero text-white hover:shadow-glow hover:scale-105 transform transition-all duration-300 shadow-large font-semibold",
        card: "bg-card text-card-foreground border border-border hover:bg-gradient-card hover:shadow-medium hover:-translate-y-1 transform transition-all duration-300",
